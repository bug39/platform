...
class Frame(LogBase, CodecP):
    ...
    outgoing_defs:  list[DefinitionMsg]                                       
    incoming_defs:  dict[GlobalRID, DefinitionMsg]                                          
    lrid_to_rmsg:   dict[LocalRID, UserResourceMsg]                                              
    ...
    def exec_incoming_request(
        ...
        if send_fn:
            assert send_fn(response_msg) is None                                       
        return response_msg
    ...
    def decode_incoming_definition(
        ...
        if not data.MIGHT_ALIAS:
            ...
            self.lrid_to_rmsg[lrid] = UserResourceMsg(grid)                          
