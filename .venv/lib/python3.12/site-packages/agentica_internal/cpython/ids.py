...
class SysClassID(enum.IntEnum):
    ...
    OS_stat_result                   = 0x900      
    T__SpecialForm                   = 0xE11                                   
