...
if not (3, 12) <= version_info[:2] <= (3, 13):
    raise RuntimeError("Agentica only supports Python versions 3.12.x - 3.13.x in this release.")
...
forbidden.blacklist_modules('agentica.')
